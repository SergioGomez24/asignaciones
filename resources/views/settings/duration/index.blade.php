  ...
  <div class="offset-md-1 col-md-10">
    <div class="card">
      <div class="card-header">
        ...
        <a class="btn btn-primary btn-sm" href="{{ url('/settings/duration/create') }}" style="float: right;">Añadir duración</a>
      </div>
      <div class="card-body">	
          ...
          <tbody> 
            @foreach( $arrayDuraciones as $key => $duracion )
              <tr>
                ...
                <td align="right" ><a class="btn btn-secondary btn-sm" href="{{ url('/settings/duration/edit/'.$duracion->id) }}">Editar</a></td>
