...
<nav class="bg-light">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ url('/settings/duration') }}">Duraciones</a></li>
    <li class="breadcrumb-item active" aria-current="page">Añadir Duración</li>
  </ol>
  </div>
</nav>
@stop
   ...
   <div class="offset-md-3 col-md-6">
      <div class="card">
         <div class="card-header">
            <h5 class="text-center"> Añadir Duración </h5>
         </div>
