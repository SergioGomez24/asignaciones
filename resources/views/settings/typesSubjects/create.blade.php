...
<nav class="bg-light">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Añadir Tipo Asignatura</li>
  </ol>
  </div>
</nav>
@stop
      ...
      <div class="card">
         ...
         <div class="card-body" style="padding:30px">
            ...
            <div class="form-group text-center">
               ...
               <a class="btn btn-secondary" href="{{ url('/settings/typesSubjects') }}" role="button" id="btnCancelar">Cancelar</a>
            </div>
            </form>
         </div>
      </div>
