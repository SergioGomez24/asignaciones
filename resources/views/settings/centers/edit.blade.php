   ...
   <div class="offset-md-3 col-md-6">
      <div class="card">
         <div class="card-header">
            <h5 class="text-center"> Editar Centro </h5>
         </div>
         <div class="card-body" style="padding:30px">
            ...
            <div class="form-group">
               ...
               <input type="text" name="name" id="name" value="{{$centro->name}}" class="form-control" required>
            </div>
            ...
            <div class="form-group text-center">
               ...
               <a class="btn btn-secondary" href="{{ url('/settings/centers') }}" role="button">Cancelar</a>
            </div>
            </form>
         </div>
      </div>
