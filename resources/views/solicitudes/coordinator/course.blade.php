  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        ...
        <button class="btn btn-light btn-sm" style="float: left;"><a href="{{ url('/solicitudes/coordinator') }}"><img src="{{ asset('img/keyboard_return.png') }}" height="15" width="15"/></a></button>
        ...
        <div class="collapse" id="collapseExample">
          <div class="card card-body">
            <form href = "solicitudes/coordinator/course/{$course}" method="GET">
              <div class="group row">
